export const themes = {
  ...
  contemporany: [
    `url(${require(`../Images/Contemporaneo/0.jpg`)})`,
    `url(${require(`../Images/Contemporaneo/1.jpg`)})`,
    `url(${require(`../Images/Contemporaneo/2.jpg`)})`,
    `url(${require(`../Images/Contemporaneo/3.jpg`)})`,
    `url(${require(`../Images/Contemporaneo/0.jpg`)})`,
    `url(${require(`../Images/Contemporaneo/1.jpg`)})`,
    `url(${require(`../Images/Contemporaneo/2.jpg`)})`,
    `url(${require(`../Images/Contemporaneo/3.jpg`)})`,
